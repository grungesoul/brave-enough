...
const LEVELS = [
  {
    ...
    npcs: [
      { name: 'The Anxious Echo', calmRestore: 0, cpRestore: 0, sprite: 'npc-guy', tint: 0x8888aa },
      { name: 'The Hall Monitor of Mistakes', calmRestore: 0, cpRestore: 0, sprite: 'npc-robot' },
      { name: 'The Encouraging Scrawl', calmRestore: 10, cpRestore: 0, sprite: 'npc-girl' }
    ],
    boss: {
  ...
  },
  {
    ...
    npcs: [
      { name: 'The Gossiping Silhouettes', calmRestore: 0, cpRestore: 0, sprite: 'npc-guy', tint: 0x555577 },
      { name: 'The Friend at a Locker', calmRestore: 0, cpRestore: 5, sprite: 'npc-guy' },
      { name: 'The Mirror Locker', calmRestore: 8, cpRestore: 0, sprite: 'npc-girl', tint: 0xaaddff }
    ],
    boss: {
  ...
  },
  {
    ...
    npcs: [
      { name: 'The Teammate on the Bench', calmRestore: 0, cpRestore: 0, sprite: 'npc-guy' },
      { name: 'The Whistle', calmRestore: 0, cpRestore: 0, sprite: 'npc-robot' },
      { name: 'The Left-Behind Trophy', calmRestore: 10, cpRestore: 0, sprite: 'npc-girl', tint: 0xffdd88 }
    ],
    boss: {
  ...
  },
  {
    ...
    npcs: [
      { name: 'The Actor in the Wings', calmRestore: 0, cpRestore: 0, sprite: 'npc-guy', tint: 0xccccff },
      { name: 'The Empty Microphone', calmRestore: 10, cpRestore: 15, sprite: 'npc-robot' },
      { name: 'The Director\'s Note', calmRestore: 12, cpRestore: 0, sprite: 'npc-girl' }
    ],
    boss: {
  ...
  },
  {
    ...
    npcs: [
      { name: 'The Memory', calmRestore: 15, cpRestore: 20, sprite: 'npc-girl', tint: 0x88ffee },
      { name: 'The Spark\'s Full Form', calmRestore: 50, cpRestore: 100, fullRestore: true, sprite: 'npc-guy', tint: 0xffd700 }
    ],
    boss: {
