...
All assets are free packs used with attribution. Thank you to these artists!
...
- **Juhani Junkala (SubspaceAudio)** — https://opengameart.org/content/4-chiptunes-adventure — CC0
  - Music: `audio/music/title`, `world`, `battle`, `boss-final` (.ogg/.m4a)
- **Kenney** — https://kenney.nl — CC0
  - RPG Audio, Interface Sounds, Digital Audio packs: all SFX (`audio/sfx/*.ogg`)

## Font

- **Press Start 2P** — Cody "CodeMan38" Boisclair — SIL Open Font License
  - `fonts/PressStart2P-Regular.ttf`

## Engine

- **Phaser 3** (v3.90.0) — https://phaser.io — MIT License

## Frame-size manifest (measured with sips — do not guess!)
...
| sprites/boss-panico.png | 606×98 | 101×98 | 6 |
| sprites/boss-ansiedad.png | 560×153 | 112×153 | 5 |
| sprites/gems.png | 848×176 | TBD | measure before use |
| fx/hit.png | 93×32 | 31×32 | 3 |
| fx/enemy-death.png | 384×48 | 48×48 | 8 |
| fx/explosion.png | 256×32 | 32×32 | 8 |
| fx/energy-shield.png | 408×47 | 51×47 | 8 |
| fx/electro-shock.png | 1152×96 | 128×96 | 9 |
| fx/fire-ball.png | 156×29 | 52×29 | 3 |
| fx/energy-smack.png | 1024×96 | 128×96 | 8 |
| fx/slash-circular.png | 312×48 | 52×48 | 6 |
| tiles/*.png | — | 16×16 tiles | overworld 464×336, town 384×208, dungeon 304×144, stage 320×256, school 256×64 (16 cols) |
| ui/parallax-*.png | 272×160 | full layer | 3 layers (back/middle/front) |
