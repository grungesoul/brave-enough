...
const TRANSLATIONS = {
  en: {
    ...
    battleBreak: 'BREAK!',
    battleVulnerable: 'VULNERABLE',
    battleWeakHit: 'Weak point!',
    battleBossStunned: 'It reels — it can\'t strike back!',
  ...
  es: {
    ...
    battleBreak: '¡ROTURA!',
    battleVulnerable: 'VULNERABLE',
    battleWeakHit: '¡Punto débil!',
    battleBossStunned: 'Se tambalea... ¡no puede contraatacar!',
